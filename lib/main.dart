...
class MyApp extends StatelessWidget{
  ...
  Widget build (BuildContext context){
    return MaterialApp(
      home:Scaffold(appBar: AppBar(title: const Text('Calculator')
      ),
      body : const Padding(padding: EdgeInsets.all(18.0),
      child: SizedBox(
  ...
  Widget build(BuildContext context){
    var calc = SimpleCalculator(
      ...
      theme: const CalculatorThemeData(
        ...
        displayStyle: TextStyle(fontSize: 80, color: Colors.green),
    ...
    return OutlinedButton(child: Text(_currentValue.toString()),
    onPressed: (){
